...
app.get('/api/match/:id', async (req, res) => {
    try {
        ...
        const detailUrl = `https://www.livescore.com/_next/data/ZdrlNTWN5LfSfo4V5JcX0/en/football/${country}/${stage}/${team1}-vs-${team2}/${matchId}.json`;
...
app.get('/api/match/:id/stats', async (req, res) => {
    try {
        ...
        const statsUrl = `https://www.livescore.com/_next/data/ZdrlNTWN5LfSfo4V5JcX0/en/football/${country}/${stage}/${team1}-vs-${team2}/${matchId}/stats.json`;
...
app.get('/api/match/:id/lineups', async (req, res) => {
    try {
        ...
        const lineupsUrl = `https://www.livescore.com/_next/data/ZdrlNTWN5LfSfo4V5JcX0/en/football/${country}/${stage}/${team1}-vs-${team2}/${matchId}/lineups.json`;
